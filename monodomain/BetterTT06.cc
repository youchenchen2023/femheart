                ...
                wo_mgarray_ptr<double> ___dVm)
{
   ...
   for (unsigned __jj=0; __jj<(nCells_+width-1)/width; __jj++)
   {
      ...
      //get the other differential updates
      real i_CalTerm3 = _interpolant[25].eval(V);
...
const string ThisReaction::getUnit(const std::string& varName) const
{
   ...
   else if (varName == "i_K1") { return "V/s"; } //INVALID
   else if (varName == "i_Kr") { return "V/s"; } //INVALID
   else if (varName == "i_Ks") { return "V/s"; } //INVALID
   else if (varName == "i_Na") { return "V/s"; } //INVALID
   else if (varName == "i_NaCa") { return "V/s"; }
   else if (varName == "i_NaK") { return "V/s"; } //INVALID
   else if (varName == "i_b_Ca") { return "V/s"; }
   else if (varName == "i_b_Na") { return "V/s"; } //INVALID
   else if (varName == "i_leak") { return "V/s"; } //INVALID
   else if (varName == "i_p_Ca") { return "V/s"; }
   else if (varName == "i_p_K") { return "V/s"; } //INVALID
   else if (varName == "i_rel") { return "V/s"; } //INVALID
   else if (varName == "i_to") { return "V/s"; } //INVALID
   else if (varName == "i_up") { return "V/s"; } //INVALID
   else if (varName == "i_xfer") { return "V/s"; } //INVALID
   else if (varName == "j") { return "1"; }
   else if (varName == "m") { return "1"; }
   else if (varName == "r") { return "1"; }
   else if (varName == "s") { return "1"; }
   else if (varName == "Vm") { return "1"; }
   return "INVALID";
}
...
int ThisReaction::getVarHandle(const std::string& varName) const
{
   ...
   else if (varName == "Vm") { return Vm_handle; }
   return -1;
}
...
void ThisReaction::setValue(int iCell, int varHandle, double value) 
{
   ...
   else if (varHandle == Vm_handle) { READ_STATE(Vm,iCell) = value; }
}

double ThisReaction::getVm(int iCell) 
{
   return READ_STATE(Vm,iCell);
}
...
double ThisReaction::getValue(int iCell, int varHandle, double V) const
{
   ...
   const double Vm=READ_STATE(Vm,iCell);
   if (0) {}
                                     ...
                                     vector<string>& fieldUnits) const
{
   ...
   fieldNames.push_back("i_CaL");
   fieldUnits.push_back(getUnit("i_CaL"));
   fieldNames.push_back("i_K1");
   fieldUnits.push_back(getUnit("i_K1"));
   fieldNames.push_back("i_Kr");
   fieldUnits.push_back(getUnit("i_Kr"));
   fieldNames.push_back("i_Ks");
   fieldUnits.push_back(getUnit("i_Ks"));
   fieldNames.push_back("i_Na");
   fieldUnits.push_back(getUnit("i_Na"));
   fieldNames.push_back("i_NaCa");
   fieldUnits.push_back(getUnit("i_NaCa"));
   fieldNames.push_back("i_NaK");
   fieldUnits.push_back(getUnit("i_NaK"));
   fieldNames.push_back("i_b_Ca");
   fieldUnits.push_back(getUnit("i_b_Ca"));
   fieldNames.push_back("i_b_Na");
   fieldUnits.push_back(getUnit("i_b_Na"));
   fieldNames.push_back("i_leak");
   fieldUnits.push_back(getUnit("i_leak"));
   fieldNames.push_back("i_leak");
   fieldUnits.push_back(getUnit("i_leak"));
   fieldNames.push_back("i_p_Ca");
   fieldUnits.push_back(getUnit("i_p_Ca"));
   fieldNames.push_back("i_p_K");
   fieldUnits.push_back(getUnit("i_p_K"));
   fieldNames.push_back("i_p_Ca");
   fieldUnits.push_back(getUnit("i_p_Ca"));
   fieldNames.push_back("i_rel");
   fieldUnits.push_back(getUnit("i_rel"));
   fieldNames.push_back("i_to");
   fieldUnits.push_back(getUnit("i_to"));
   fieldNames.push_back("i_up");
   fieldUnits.push_back(getUnit("i_up"));
   fieldNames.push_back("i_xfer");
   fieldUnits.push_back(getUnit("i_xfer"));
   fieldNames.push_back("Vm");
   fieldUnits.push_back(getUnit("Vm"));
